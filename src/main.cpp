...
uint256 hashGenesisBlock("0xa037aab70d3eda329e55163a2ee49479529c4ccb795334833922a248b15f1c8b");
...
{
    // Africoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "africoin genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	    ...
	    assert(block.hashMerkleRoot == uint256("0x014e5ceb76d1b233cc644038d14c4c97389b42e32dbcded0f69309ffeda677d7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xda, 0xea, 0xef, 0xbb };
